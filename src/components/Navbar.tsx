...
export function Navbar() {
    // Access the openCart function and cartQuantity from the shopping cart context
            ...
            <Container>
                ...
                {cartQuantity > 0 && (
                    ...
                    >
                        ...
                        justify-content-center align-items-center" style={{ color: "white", width: "20px", height: "20px", position: "absolute", bottom: "0", right: "0", transform: "translate(15%, 15%)" }} >
                            {cartQuantity}
                        </div>
                    </Button>
                )}
